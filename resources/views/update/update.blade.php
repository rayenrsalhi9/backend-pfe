...
<div class="panel">
    <h3 class="text-success-500">Great! No update available at this time. Your system is up-to-date and running smoothly.</h3>
...
<form class="panel" action="update/run" method="post">
    {{ csrf_field() }}
    <p class="text-success-500">Exciting update! A new version is available for your system. Stay ahead with the latest features, improvements, and enhancements by updating now.</p>
